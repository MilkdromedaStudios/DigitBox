      ...
      {visiting && (
        <aside className={"df-city-arrival" + (isMyCity ? " mine" : " visitor")}>
          <div className="df-city-arrival-head">
            ...
            {isMyCity && <button className="df-city-customize-toggle" onClick={openCustomization}>CUSTOMIZE</button>}
          </div>
            ...
            <>
              ...
              <div className="df-city-town-upgrades">
                {BUILDINGS.map((building) => {
                  ...
                  return (
                    <button key={building.key} disabled={Boolean(visiting.ownerFortress)} onClick={() => props.upgradeBuilding && props.upgradeBuilding(building)}>
                      <span>{building.icon}</span>
                      <div><b>{building.name}</b><small>{visiting.ownerFortress ? "OWNER MAX · " : "LEVEL " + level + " · "}{building.desc}</small></div>
                      <em>{visiting.ownerFortress ? "MAX" : "$" + cost.toLocaleString()}</em>
                    </button>
                  );
                })}
              </div>
