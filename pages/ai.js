    ...
    <div className="content ai-page">
      ...
      {configured === false && (
        <div className="notice notice-warn" role="status">
          ...
          <code> AI_API_KEY</code> set. An admin can add a free key (Groq, Google Gemini,
          OpenRouter or Hugging Face) — see <code>docs/DIGITBOX_AI_SETUP.md</code>. You can
          still browse the chat and API docs below.
        </div>
      )}
