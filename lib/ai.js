...
const PRESETS = {
  // GitHub Models — free for GitHub users, OpenAI-compatible. The API key is a
  // GitHub personal-access token with the "models: read" permission.
...
export function getAiConfig() {
  const provider = String(process.env.AI_PROVIDER || "huggingface").toLowerCase();
  const preset = PRESETS[provider] || PRESETS.huggingface;
